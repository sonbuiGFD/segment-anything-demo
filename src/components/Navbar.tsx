  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-center w-full bg-white md:border-b-gray-200 md:border-b-[1px] pt-3 pb-3">
      <img
        ...
        alt="Mobile Menu"
      />
      <NavLink className="mt-2 text-xl font-bold leading-tight md:mx-6 lg:text-2xl" onClick={resetState} to={"/"} style={{ fontWeight: 700 }}>
        <div>Segment Anything</div>
        <div className="text-xs font-normal text-center text-gray-500 lg:text-sm md:text-start">Research by Meta AI</div>
      </NavLink>
      <div className="hidden ml-auto md:flex [&>*]:flex [&>*]:items-center h-full">
        <NavLink
          onClick={resetState}
          className={`hover:underline underline-offset-4 ${desktopClasses} ${location.pathname === "/" && "underline text-blue-700"}`}
          to={"/"}
        >
          Home
        </NavLink>
        <NavLink
          onClick={resetState}
          className={`hover:underline underline-offset-4 ${desktopClasses} ${location.pathname === "/demo" && "underline text-blue-700"} `}
          to={"/demo"}
        >
          Demo
        </NavLink>
        <a onClick={resetState} className={`hover:underline underline-offset-4 ${desktopClasses}`} href={"/dataset/index.html"}>
          Dataset
        </a>
        <a
          onClick={resetState}
        ...
        <a className="mr-6 min-w-[24px]" href="https://github.com/facebookresearch/segment-anything" target={"_blank"}>
          <img
      ...
      <div
        className={
          ...
          (isMenuOpen ? " transition-opacity opacity-100 duration-500 translate-x-0  " : " transition-all delay-500 opacity-0 translate-x-full  ")
        }
      >
        <section
          className={
        ...
        >
          <article className="relative flex flex-col w-screen h-full max-w-lg pb-10 mt-8 space-y-6 overflow-y-scroll">
            ...
            <NavLink
              ...
              className={`${mobileClasses} hover:underline underline-offset-4 ${location.pathname === "/" && "underline text-blue-700"}`}
              to={"/"}
            >
              Home
            </NavLink>
            <NavLink
              ...
              className={`${mobileClasses} hover:underline underline-offset-4 ${location.pathname === "/demo" && "underline text-blue-700"}`}
              to={"/demo"}
            >
              Demo
            </NavLink>
