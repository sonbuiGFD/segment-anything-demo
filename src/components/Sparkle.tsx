...
const Sparkle = ({ isActive }: { isActive: Boolean }) => {
  ...
  return (
    <>
      <svg className="w-5 m-1 md:m-0" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M8 3L5.5 8.5L0 11L5.5 13.5L8 19L10.5 13.5L16 11L10.5 8.5"
          fill={isActive ? FILL : "#000"}
          className={`${isModelLoaded.allModel ? "" : "ease-in-out duration-1000"}${
