...
const canvasScaleInitializer = ({ width, height, containerRef, shouldFitToWidth }: canvasScaleInitializerProps) => {
...
const canvasScaleResizer = ({ width, height, containerWidth, containerHeight, shouldFitToWidth }: canvasScaleResizerProps) => {
