...
const CookieBanner = ({ onAccept, onDecline }: any) => {
  return (
    ...
    >
      We use cookies and similar technologies to help provide the content on the Segment Anything site and for analytics purposes. You can learn more
      about cookies and how we use them in our{" "}
      <Link to={"/cookies"} target="_blank" rel="noreferrer" className="underline">
        <b>Cookie Policy</b>
      </Link>
      .
    </CookieConsent>
